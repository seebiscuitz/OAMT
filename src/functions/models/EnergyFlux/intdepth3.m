function [ intH, Hmin ] = intdepth3( H, source, lat, lon )
...
%   Detailed explanation goes here
    ...
    Hmin=zeros(n1,n2);
    warning('off','all')
    %intdepthwait=waitbar(0,sprintf('Calculating depth integral 0/%d',n));
    for i=1:n1
        %waitbar(i/n,intdepthwait,sprintf('Calculating depth integral %d/%d',i,n));
        rdiff=i-idy;
        %fprintf('\n%d',i)
        %tic
        for j=1:n2
